...
namespace CBD.Controllers
{
    public class TagsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Tag.Include(t => t.Author).Include(t => t.Build);
        ...
        public async Task<IActionResult> Create([Bind("Id,BuildId,AuthorId,Text")] Tag tag)
        {
            ...
            ViewData["BuildId"] = new SelectList(_context.Build, "Id", "Id", tag.BuildId);
            return View(tag);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BuildId,AuthorId,Text")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
